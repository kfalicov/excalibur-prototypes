...
import particleWGSL from './wgsl/particle.wgsl?raw';
import probabilityMapWGSL from './wgsl/probabilityMap.wgsl?raw';
import { quitIfWebGPUNotAvailable } from '../utils/webgpu';
...
const view: Tuple<number, 16> = mat4.create();
const mvp: Tuple<number, 16> = mat4.create();
